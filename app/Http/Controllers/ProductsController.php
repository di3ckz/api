...
class ProductsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('product.create')->with('message','Productos Agregados con exito!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('product.index')->with('message',' Productos Actualizados con exito!');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('product.index')->with('message','Eliminacion exitosa!');
    }
