...
class CategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('category.index')->with('message','Agregado exitoso!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('category.index')->with('message','Actualizado exitoso!');
    }
    ...
    public function destroy($id)
    {
        ...
        $delete->delete();
        return redirect()->route('category.index')->with('message','Eliminacion exitosa!');
    }
}
