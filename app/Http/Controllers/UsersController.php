...
class UsersController extends Controller
{
    ...
    public function register(Request $request){
        ...
        return back()->with('message','registrado!');
    }
    ...
    public function updatepassword(Request $request,$id){
        ...
        if(Hash::check($input_data['password'],$oldPassword->password)){
            ...
            return back()->with('message','Password actualizada correctamente!');
        }else{
            return back()->with('oldpassword','Password anterior Incorrecta!');
        }
    }
}
