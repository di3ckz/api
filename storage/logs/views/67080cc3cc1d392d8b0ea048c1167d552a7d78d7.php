<?php $__env->startSection('title','Add Coupons Page'); ?>
<?php $__env->startSection('content'); ?>
    <div id="breadcrumb"> <a href="<?php echo e(url('/admin')); ?>" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="<?php echo e(route('coupon.index')); ?>">Coupons</a> <a href="<?php echo e(route('coupon.create')); ?>" class="current">Add New Coupon</a> </div>
