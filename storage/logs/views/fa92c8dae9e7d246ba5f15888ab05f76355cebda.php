<?php $__env->startSection('title','Editar cupones'); ?>
<?php $__env->startSection('content'); ?>
    <div id="breadcrumb"> <a href="<?php echo e(url('/admin')); ?>" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="<?php echo e(route('coupon.index')); ?>">Coupones</a> <a href="#" class="current">Editar Cupon</a> </div>
    <div class="container-fluid">
        <?php if(Session::has('message')): ?>
            <div class="alert alert-success text-center" role="alert">
                <strong>Bien echo! &nbsp;</strong><?php echo e(Session::get('message')); ?>

            </div>
        <?php endif; ?>
        <div class="widget-box">
            <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
                <h5>Agregar nuevo cupón</h5>
            </div>
            <div class="widget-content nopadding">
                <form action="<?php echo e(route('coupon.update',$edit_coupons->id)); ?>" method="post" class="form-horizontal">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls<?php echo e($errors->has('coupon_code')?' has-error':''); ?>">
                            <input type="text" name="coupon_code" id="coupon_code" class="form-control" value="<?php echo e($edit_coupons->coupon_code); ?>"
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls<?php echo e($errors->has('amount')?' has-error':''); ?>">
                            <input type="number" min="0" name="amount" id="amount" class="form-control" value="<?php echo e($edit_coupons->amount); ?>" title="" required="required" style="width: 400px;">
                        ...
                        <div class="controls<?php echo e($errors->has('expiry_date')?' has-error':''); ?>">
                            <div class="input-prepend">
                                <div  data-date="12-02-2012" class="input-append date datepicker">
                                    <input type="text" name="expiry_date" id="expiry_date" value="<?php echo e($edit_coupons->expiry_date); ?>"  data-date-format="yyyy-mm-dd" class="span11" style="width: 375px;" placeholder="yyyy-mm-dd">
                    ...
                    <div class="control-group<?php echo e($errors->has('status')?' has-error':''); ?>">
                        ...
                        <div class="controls">
                            <input type="checkbox" name="status" id="status" value="1" <?php echo e($edit_coupons->status==1?'checked':''); ?>>
