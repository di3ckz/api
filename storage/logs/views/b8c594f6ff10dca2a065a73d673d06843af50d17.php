<?php $__env->startSection('title','imformacion'); ?>
            ...
            <form action="<?php echo e(url('/submit-checkout')); ?>" method="post" class="form-horizontal">
                <div class="col-sm-4 col-sm-offset-1">
                    <div class="login-form"><!--login form-->
                        ...
                        <legend> Imformacion de contacto </legend>
                        <div class="form-group <?php echo e($errors->has('billing_name')?'has-error':''); ?>">
                            <input type="text" class="form-control" name="billing_name" id="billing_name" value="<?php echo e($user_login->name); ?>" placeholder="Nombre Completo">
                        ...
                        <div class="form-group <?php echo e($errors->has('billing_address')?'has-error':''); ?>">
                            <input type="text" class="form-control" value="<?php echo e($user_login->address); ?>" name="billing_address" id="billing_address" placeholder="Domicilio">
                        ...
                        <div class="form-group <?php echo e($errors->has('billing_city')?'has-error':''); ?>">
                            <input type="text" class="form-control" name="billing_city" value="<?php echo e($user_login->city); ?>" id="billing_city" placeholder="Ciudad">
                        ...
                        <div class="form-group <?php echo e($errors->has('billing_state')?'has-error':''); ?>">
                            <input type="text" class="form-control" name="billing_state" value="<?php echo e($user_login->state); ?>" id="billing_state" placeholder=" Estado">
                        ...
                        <div class="form-group <?php echo e($errors->has('billing_pincode')?'has-error':''); ?>">
                            <input type="text" class="form-control" name="billing_pincode" value="<?php echo e($user_login->pincode); ?>" id="billing_pincode" placeholder=" codigo postal">
                        ...
                        <div class="form-group <?php echo e($errors->has('billing_mobile')?'has-error':''); ?>">
                            <input type="text" class="form-control" name="billing_mobile" value="<?php echo e($user_login->mobile); ?>" id="billing_mobile" placeholder="Telefono">
                            <span class="text-danger"><?php echo e($errors->first('billing_mobile')); ?></span>
                        </div>

                        <span>
                            <input type="checkbox" class="checkbox" name="checkme" id="checkme">Dirección de envío igual que dirección de facturación
                        </span>
                    </div><!--/login form-->
                </div>
                <div class="col-sm-1">
                ...
                <div class="col-sm-4">
                    <div class="signup-form"><!--sign up form-->
                        ...
                        <div class="form-group <?php echo e($errors->has('shipping_address')?'has-error':''); ?>">
                            <input type="text" class="form-control" value="" name="shipping_address" id="shipping_address" placeholder="Domicilio">
                        ...
                        <div class="form-group <?php echo e($errors->has('shipping_state')?'has-error':''); ?>">
                            <input type="text" class="form-control" name="shipping_state" value="" id="shipping_state" placeholder="Estado">
                        ...
                        <button type="submit" class="btn btn-primary" style="float: right;">Envío a</button>
                    </div><!--/sign up form-->
                </div>
            </form>
        </div>
