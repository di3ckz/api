...
<?php $__env->startSection('content'); ?>
    <div id="breadcrumb"> <a href="<?php echo e(url('/admin')); ?>" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Inicio</a> <a href="<?php echo e(route('category.index')); ?>">Categorias</a> <a href="<?php echo e(route('category.create')); ?>" class="current">Agregar Nueva Categoria</a> </div>
                ...
                <div class="widget-content nopadding">
                    <form class="form-horizontal" method="post" action="<?php echo e(route('category.store')); ?>" name="basic_validate" id="basic_validate" novalidate="novalidate">
                        ...
                        <div class="control-group<?php echo e($errors->has('url')?' has-error':''); ?>">
                            <label class="control-label">URL (Empieza http://) :</label>
                            <div class="controls">
