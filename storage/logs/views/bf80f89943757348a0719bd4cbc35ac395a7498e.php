        ...
        <div class="auth-box bg-dark border-top border-secondary">
            <div id="loginform">
                ...
                <?php if(Session::has('message')): ?>
                    <div class="text-center p-t-20 p-b-20 danger">
                        <span class="alert alert-danger"><?php echo e(Session::get('message')); ?></span>
                    </div>
                <?php endif; ?>
                <!-- Form -->
                <form class="form-horizontal m-t-20" id="loginform" method="POST" action="<?php echo e(route('admin_login')); ?>">
                    <?php echo csrf_field(); ?>
                    <div class="row p-b-30">
                        <div class="col-12">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control form-control-lg" name="email" value="<?php echo e(old('email')); ?>" placeholder="Email" aria-label="Email" aria-describedby="basic-addon1" required="">
                            </div>
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
