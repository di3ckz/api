<?php $__env->startSection('title','Agregar imagenes '); ?>
<?php $__env->startSection('content'); ?>
    <div id="breadcrumb"> <a href="<?php echo e(url('/admin')); ?>" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> inicio</a> <a href="<?php echo e(route('product.index')); ?>">Productos</a> <a href="#" class="current">añadir imagenes</a> </div>
            ...
            <div class="span6">
                <div class="widget-box">
                    <div class="widget-title"> <span class="icon"> <i class="icon-file"></i> </span>
                        <h5>Producto : <?php echo e($product->p_name); ?></h5>
                    </div>
                        ...
                        <ul class="recent-posts">
                            <li>
                                ...
                                <div class="article-post">
                                    <span class="user-info">codigo de producto <b><?php echo e($product->p_code); ?></b></span>
                                    <p>color de producto <b><?php echo e($product->p_color); ?></b></p>
                                </div>
                            </li>
                            <li>
                                <form action="<?php echo e(route('image-gallery.store')); ?>" method="post" role="form" enctype="multipart/form-data">
                                    <legend>Puede agregar imágenes múltiples</legend>
                            ...
                            <?php $i=1; ?>
                                <?php $__currentLoopData = $imageGalleries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $imageGallery): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td style="text-align: center;vertical-align: middle;"><a href="javascript:" rel="<?php echo e($imageGallery->id); ?>" rel1="delete-imageGallery" class="btn btn-danger btn-mini deleteRecord">eliminar</a></td>
                                    </tr>
