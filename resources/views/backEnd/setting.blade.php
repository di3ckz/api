...
@section('content')
    ...
    <div id="content-header">
        <div id="breadcrumb"> <a href="{{url('/admin')}}" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="current">ajustes</a> </div>
    </div>
    <!--End-breadcrumbs-->
                ...
                <div class="widget-box">
                    <div class="widget-title"> <span class="icon"> <i class="icon-info-sign"></i> </span>
                        @if(Session::has('message'))
                            <h5 class="text-danger" style="color: #d20e0e;">{{Session::get('message')}}</h5>
                        @else
