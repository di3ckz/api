...
@section('content')
    <div id="breadcrumb"> <a href="{{url('/admin')}}" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> inicio</a> <a href="{{route('product.index')}}">Productos</a> <a href="#" class="current">añadir imagenes</a> </div>
                            ...
                            <?php $i=1; ?>
                                @foreach($imageGalleries as $imageGallery)
                                    <tr>
                                        ...
                                        <td style="text-align: center;vertical-align: middle;"><a href="javascript:" rel="{{$imageGallery->id}}" rel1="delete-imageGallery" class="btn btn-danger btn-mini deleteRecord">eliminar</a></td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
