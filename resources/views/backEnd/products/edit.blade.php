...
@section('content')
    <div id="breadcrumb"> <a href="{{url('/admin')}}" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> inicio</a> <a href="{{route('product.index')}}">Productos</a> <a href="#" class="current">editar </a> </div>
            ...
            <div class="widget-content nopadding">
                <form action="{{route('product.update',$edit_product->id)}}" method="post" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="control-group">
                        <label class="control-label">Seleccionar categoría</label>
                        <div class="controls">
                    ...
                    <div class="control-group">
                        <label class="control-label">Carga de imágenes</label>
                        <div class="controls">
