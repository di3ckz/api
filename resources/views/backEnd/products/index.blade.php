...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="widget-box">
            ...
            <form action="{{url('admin/productos_excel')}}" method="get">
                @csrf  
                ...
                <table class="table table-bordered data-table">
                    ...
                    @foreach($products as $product)
                        ...
                        <tr class="gradeC">
                            ...
                            <td style="vertical-align: middle;text-align: center;"><a href="{{route('image-gallery.show',$product->id)}}" class="btn btn-default btn-mini">Agregar Imagenes</a></td>
                            <td style="vertical-align: middle;text-align: center;"><a href="{{route('product_attr.show',$product->id)}}" class="btn btn-success btn-mini">Agregar Atributos</a></td>
                            <td style="text-align: center; vertical-align: middle;">
                                <a href="#myModal{{$product->id}}" data-toggle="modal" class="btn btn-info btn-mini">Ver</a>
