...
@section('title','Agregar nurevo cupon')
@section('content')
    <div id="breadcrumb"> <a href="{{url('/admin')}}" title="Go to Home" class="tip-bottom"><i class="icon-home"></i>Inicio</a> <a href="{{route('coupon.index')}}">Cupones</a> <a href="{{route('coupon.create')}}" class="current">Agregar nuevo cupon</a> </div>
