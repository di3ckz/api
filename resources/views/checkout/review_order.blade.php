...
@section('title','Revisar página de pedido')
@section('slider')
@endsection
@section('content')
    <div class="container">
        <div class="step-one">
            <h2 class="heading">Envío a</h2>
        </div>
        <div class="row">
            <form action="{{url('/submit-order')}}" method="post" class="form-horizontal">
                ...
                <div class="col-sm-12">
                    ...
                    <section id="cart_items">
                                ...
                                <tr>
                                    ...
                                    <td colspan="2">
                                        <table class="table table-condensed total-result">
                                            <tr>
                                                <td>Carro Sub Total</td>
                                                <td>$ {{$total_price}}</td>
                                            </tr>
                                            @if(Session::has('discount_amount_price'))
                                                <tr class="shipping-cost">
                                                    <td>Descuento de cupón</td>
                        ...
                        <span>
                            <label><input type="radio" name="payment_method" value="COD" checked> Efectivo en la entrega</label>
                        </span>
                            <span>
