...
Route::group(['prefix'=>'admin','middleware'=>['auth','admin']],function (){
    ...
    Route::get('/categorias_excel', function () {
    ob_end_clean();
    ob_start();
    return Excel::download(new CategoryExport, 'categorias.xlsx');
    });
    Route::get('/productos_excel', function () {
    ob_end_clean();
    ob_start();
    return Excel::download(new ProductExport, 'productos.xlsx');
    });
    Route::get('/cupones_excel', function () {
    ob_end_clean();
    ob_start();
    return Excel::download(new CouponExport, 'cupones.xlsx');
    });
///
});
